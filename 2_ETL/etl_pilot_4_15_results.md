# ETL Results — `etl.py --case tiny` (pilot_4_15)
...
Output: `pilot_4_15.ttl` (30 KB, 398 triples)
Disagreement log: `disagreements_tiny_20260407_220906.jsonl`
...
| 1 | Sybil - Lung Cancer Prediction Model by MIT | 3 | 80% | B | NO | BG_10_1, BG_4_1, BG_3_2 |
| 2 | Babel | 2 | 100% | A | NO | BG_7_1, BG_4_1 |
| 3 | Automated Target Recognition (ATR) Developments for Standard Screening | 3 | 50% | A | NO | BG_10_1, BG_4_1, BG_2_4 |
| 4 | Document Review Tool | 2 | 100% | A | NO | BG_4_1, BG_7_4 |
| 5 | Complaint Summarization | 2 | 100% | A | NO | BG_4_4, BG_4_1 |
| 6 | Spoofing Detection AI/ML Project | 2 | 100% | A | NO | BG_7_1, BG_7_4 |
| 7 | Stress Testing Scenarios with Deep Learning | 3 | 0% | Sonnet | yes | BG_5_4, BG_1_4, BG_9_1 |
| 8 | MPD Entity Risk Modeling | 2 | 100% | A | NO | BG_7_1, BG_3_3 |
...
| 11 | Generative AI Tools Pilot - Global Markets | 3 | 0% | Sonnet | yes | BG_4_1, BG_1_2, BG_2_2 |
...
- Mean goals per use case (LLM-tagged, excl. blacklisted): 2.33
- Min: 1, Max: 3
...
| aiu:BG_7_1 | Regulatory and legal compliance | 3/15 |
...
| aiu:BG_5_4 | Leverage, market risk, and financial risk management | 1/15 |
| aiu:BG_1_4 | Strategic planning and scaling under uncertainty | 1/15 |
...
| Metric | Value |
|---|---|
| Agreed (Sonnet == GPT exact match) | 3/15 (20%) |
| Disagreements | 12/15 |
| Average disagreement % | 90.0% |
| Opus chose Sonnet (A) | 10 |
| Opus chose GPT (B) | 2 |
| Logged (>30% threshold) | 12 |
